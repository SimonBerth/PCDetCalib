"""
Taken from open-mmlab's computation of rotated 2D IoU in mmdetection3d (https://github.com/open-mmlab/mmdetection3d) and OpenPCDet (https://github.com/open-mmlab/OpenPCDet)
